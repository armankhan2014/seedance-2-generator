...
// The "recipe" — hidden from users, restores the previous ABSOLUTE RULE prompt
// (more accurate for face preservation per user feedback) with the mandatory
// close-up clause kept from the recent fix.
...
- Panel 4: A SINGLE close-up portrait of the face from the front — head and shoulders only. THIS PANEL IS MANDATORY. Every output must include a clear face close-up as the rightmost panel. Do not omit it. Do not replace it with another body view.
